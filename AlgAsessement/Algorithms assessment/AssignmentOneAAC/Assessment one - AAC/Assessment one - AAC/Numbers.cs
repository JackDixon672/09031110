...
namespace Assessment_one___AAC
{
    class Numbers : Searching
    {
        ...
        {
            //Constructor to provide the object with necessary information
        ...
        {
            //"Starting" the merge sort method, with a new temp array
        ...
        public void mergeSort(int[] array, int[] temp, int leftPointer, int rightPointer)
        {
            ...
            int i;
            count++;
            //Stopping the method once n is too small
            if (n < 2) return;

            //Copying the necessary parts of the array into the temp array
